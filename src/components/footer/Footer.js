        ...
        <div className={`mobile-collapsed-wrapper ${collapsedShow === true ? "active" : ""}`}>
          ...
          <section className="data_wrapper">
            <ul className="list-none">
              <li>
                <span>Konfiguration zzgl. <br/>Installation <br/>(inkl. 19% MwSt.)</span>
                <h2>50.000.00 €</h2>
              </li>
              <li>
                <span>Mtl. Rate</span>
              ...
              <li>
                <Link to="/">Konfiguration speichern <i className="fa fa-angle-right"></i></Link>
              </li>
              <li>
                <Link to="/">PDF speichern <i className="fa fa-angle-right"></i></Link>
              </li>
              <li className="column-direction content-justify-start items-start">
                <Link to="/">Konfiguration prüfen lassen <i className="fa fa-angle-right"></i></Link>
          ...
          <section className="flex items-center button-wrap">
            <Link to="/" className="submit-button transparent">Jetzt beauftragen</Link>
