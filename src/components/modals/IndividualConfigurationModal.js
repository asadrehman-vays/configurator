          ...
          <div className="modal-body">
            <div className="modal-forms">
              ...
              <ul className="list-none">
                ...
                <li>
                  <h5>Grundriss</h5>
                  <p>Laden Sie Ihren Elektroplan, Grundrisse und Fotos und Videos vom Objekt hoch, damit wir Ihr Konzept so genau wie möglich planen können.</p>
                </li>
                <li>
                    ...
                    {!selectedImage && (
                        <>
                          ...
                          <section className='mobile'>
                            <span><small>Datei auswählen <i className="fa fa-angle-right"></i></small></span>
                          </section>
                          <small>pdf  jpg  png  doc</small>
                        </>
                      )
                    }
                    <span className="desktop">Oder Datei <small>auswählen</small></span>
                    <span className="mobile"><img src={camIcon} alt="cam"/> <small>Fotografieren <i className="fa fa-angle-right"></i></small></span>
                  </div>
                </li>
                <li><p>Indem Sie auf “Speichern” klicken, akzeptieren Sie unsere <Link to="/">Datenschutzbedingungen</Link>.</p></li>
              </ul>
