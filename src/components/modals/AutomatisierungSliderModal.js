...
import cover1 from "../../assets/images/automatisierung1.png";
import cover2 from "../../assets/images/automatisierung2.png";
import cover3 from "../../assets/images/automatisierung3.png";
import cover4 from "../../assets/images/automatisierung4.png";
...
export const AutomatisierungSliderModal = (props) => {
  ...
  return (
      <div className={`modal-wrapper ${props.modalExtraClass}`}>
        <div className="modal-dialog">
          ...
          >
            {
              detailSlideData.map(({sideImage,coverImage,title,list}, index)=>{
                return(
                    <SwiperSlide key={index}>
                      <div className="modal-content">
                        <div className="modal-body">
                          <img src={crossIcon} alt="crossIcon" className="crossIcon" onClick={props.closeModal}/>
                          <div className="automatisierung-detailed-modal flex">
                            <section>
                              <h2>{title}</h2>
